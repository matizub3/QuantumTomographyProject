...
python3 main.py --problem Multi_Num -nw 5 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_model_control --rescale True -e 1000 -d True -n 1000 -w 0.4 -lr 0.002 -pe 40
