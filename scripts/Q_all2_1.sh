...
#SBATCH -o ./logs/Q_all2_1.out
#SBATCH --job-name=Q_all2_1
...
python3 main.py --problem all2 -b 1 -pe 10 -a GELU -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_model_control --rescale True -e 32000 -d True -n 600 -w 0.1 -pe 40 -lr 0.001
