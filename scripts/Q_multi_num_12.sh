...
python3 main.py --problem Multi_Num -nw 8 -b 1 -pe 10 -a GELU -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_model_control --rescale True -e 4000 -d True -n 600 -w 0.1 -pe 40
