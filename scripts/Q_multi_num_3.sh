...
#SBATCH -o ./logs/Q_multi_num_3.out
#SBATCH --job-name=Q_multi_num_3
...
python3 main.py --problem Multi_Num -nw 6 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_efficient --rescale True -e 1000 -d True -n 1000 -spr 1000 -w 0.4 -lr 0.001
#python3 main.py --problem Multi_Num -nw 8 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_efficient --rescale True -e 1000 -d True -n 2000 -spr 1000 -w 0.4
