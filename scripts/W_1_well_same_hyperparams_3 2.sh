...
#SBATCH -o ./logs/W_1_well_same_hyperparams_3.out
#SBATCH --job-name=W_1_well_same_hyperparams_3

python3 main.py -r W --problem binom_0 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 30 -nl 5 -l L1_efficient --rescale True -w 0 -d True -n 1000 -e 1000
