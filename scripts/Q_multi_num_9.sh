...
#SBATCH -o ./logs/Q_multi_num_9.out
#SBATCH --job-name=Q_multi_num_9
...
python3 main.py --problem Multi_Num -nw 5 -b 1 -pe 10 -a GELU -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_model_control --rescale True -e 4000 -d True -n 1000 -w 0.1 -pe 40
