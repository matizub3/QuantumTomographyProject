...
python3 main.py --problem Multi_Num -nw 6 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_model_control --rescale True -e 1000 -d True -n 800 -w 0.2 -lr 0.002 -pe 40
