...
#SBATCH -o ./logs/Q_1_well_same_hyperparams_2.out
#SBATCH --job-name=Q_1_well_same_hyperparams_2
...
python3 main.py --problem GKP     -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 30 -nl 5 -l KL_efficient --rescale True -w 0.05 -d True -n 1000 -e 1000
python3 main.py --problem GKP     -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 30 -nl 5 -l KL_efficient --rescale True -w 0.2 -d True -n 1000 -e 1000 