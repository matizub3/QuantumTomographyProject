...
#SBATCH -o ./logs/Q_multi_num_2.out
#SBATCH --job-name=Q_multi_num_2
...
python3 main.py --problem Multi_Num -nw 4 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_efficient --rescale True -e 1000 -d True -n 2000 -spr 1000 -w 0.4
python3 main.py --problem Multi_Num -nw 4 -b 1 -pe 10 -a SINE -res True -v False -net FFJORDNet -ls 80 -nl 5 -l KL_efficient --rescale True -e 2000 -d True -n 2000 -spr 1000 -w 0.4
